...
map<string, G4Material*> cpp_materials::initMaterials(run_conditions runConditions, gemc_opts opts)
{
	
	// TODO:
	// Many of these elements are already in the G4 Material Database:
	// http://geant4.cern.ch/UserDocumentation/UsersGuides/ForApplicationDeveloper/html/apas10.html#sect.G4MatrDb.PurMat
	...
	// 2% aluminum and the rest mylar
	G4Material *BSTMMylar = new G4Material("BSTMMylar",   density = 1.40*g/cm3, nel=4);
	BSTMMylar->AddMaterial(matman->FindOrBuildMaterial("G4_H"),  0.03);
	BSTMMylar->AddMaterial(matman->FindOrBuildMaterial("G4_C"),  0.63);
	BSTMMylar->AddMaterial(matman->FindOrBuildMaterial("G4_O"),  0.32);
	BSTMMylar->AddMaterial(matman->FindOrBuildMaterial("G4_Al"), 0.02);
    ...
    G4Material *LastaFoam = new G4Material("LastaFoam",        density = 240*mg/cm3, nel=4);
    LastaFoam->AddMaterial(matman->FindOrBuildMaterial("G4_C"), 40.45*perCent);
    LastaFoam->AddMaterial(matman->FindOrBuildMaterial("G4_H"),  7.86*perCent);
    LastaFoam->AddMaterial(matman->FindOrBuildMaterial("G4_N"), 15.73*perCent);
    LastaFoam->AddMaterial(matman->FindOrBuildMaterial("G4_O"), 35.96*perCent);
	...
	G4Material* LD2 = new G4Material("LD2", density= 0.169*g/cm3, nel=1, kStateLiquid, temp);
