...
PH_output raw_HitProcess :: ProcessHit(MHit* aHit, gemc_opts Opt)
{
	PH_output out;
...
vector<identifier>  raw_HitProcess :: ProcessID(vector<identifier> id, G4Step* aStep, detector Detector, gemc_opts Opt)
{
