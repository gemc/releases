...
my $envelope = 'HDiceN101_target';
my $file     = 'HDiceN101_target.txt';
...
{
 my $rad = $scale*25;
 my $zoff = -15.*$scale-$target_leng/2.;
...
sub make_4Kshield
{
 ...
 my $zpos = $leng2 - $mleng2 + $target_leng/4.;
...
sub make_coil_cage
{
 ...
 my $leng2 = 40./2.;
 my $zpos = +15.*$scale+$target_leng/2.;
...
sub make_coil_corr
{
 my $irad = 7.137/2.+0.1;
 my $orad = $irad+0.3;
 print("Raggio 30-40   $irad $orad \n");
 my $leng2 = 2./2.;
 my $zpos = +15.*$scale+$target_leng/2.+6.;

 $detector{"name"}        = "HD_30-40_coil_corr";
 $detector{"mother"}      = "HD_IBM";
 $detector{"description"} = "HDice 30-40 coil birdcage";
 $detector{"pos"}         = "0*cm 0.0*cm $zpos*cm";
 $detector{"rotation"}    = "0*deg 0*deg 0*deg";
 $detector{"color"}       = "fff600";
 $detector{"type"}        = "Tube";
 ...
 $detector{"name"}        = "HD_30-40_coil_corr2";
 $detector{"mother"}      = "HD_IBM";
 $detector{"description"} = "HDice 30-40 coil birdcage";
 $detector{"pos"}         = "0*cm 0.0*cm $zpos*cm";
 $detector{"rotation"}    = "0*deg 0*deg 0*deg";
 ...
 my $irad = 7.137/2.+0.1;
 my $orad = $irad+0.1;
 print("Raggio 40-70   $irad $orad \n");
 my $leng2 = 3.5/2.;
 my $zpos = +15.*$scale+$target_leng/2.+3.25;

 $detector{"name"}        = "HD_40-70_coil_corr";
 $detector{"mother"}      = "HD_IBM";
 $detector{"description"} = "HDice 30-40 coil birdcage";
 $detector{"pos"}         = "0*cm 0.0*cm $zpos*cm";
 $detector{"rotation"}    = "0*deg 0*deg 0*deg";
 ...
 $detector{"name"}        = "HD_40-70_coil_corr2";
 $detector{"mother"}      = "HD_IBM";
 $detector{"description"} = "HDice 30-40 coil birdcage";
 $detector{"pos"}         = "0*cm 0.0*cm $zpos*cm";
 $detector{"rotation"}    = "0*deg 0*deg 0*deg";
 ...
 my $irad = 7.137/2.+0.1;
 my $orad = $irad+0.15;
 print("Raggio 70-90   $irad $orad \n");
 my $leng2 = 3.0/2.;
 my $zpos = +15.*$scale+$target_leng/2.;

 $detector{"name"}        = "HD_70-90_coil_corr";
 $detector{"mother"}      = "HD_IBM";
 $detector{"description"} = "HDice 30-40 coil birdcage";
 $detector{"pos"}         = "0*cm 0.0*cm $zpos*cm";
 $detector{"rotation"}    = "0*deg 0*deg 0*deg";
