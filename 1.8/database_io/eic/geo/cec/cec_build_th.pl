...
my $r1 = 500.0;   # solenoid outer radius
...
sub make_CEC
{
 ...
 $detector{"description"} = "Central Solenoid and hadron calorimeter and muon detector";
...
make_CECtestdaugther1();
make_CECtestdaugther2();
make_CECtestdaugther3();
